                            ...
                            <table class="table">
                                ...
                                @foreach($users as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/users/' . $item->id) }}" title="View User"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Voir</button></a>
                                            <a href="{{ url('/admin/users/' . $item->id . '/edit') }}" title="Edit User"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Modifier</button></a>
                                            {!! Form::open([
                                                'method' => 'DELETE',
                                                ...
                                                {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i> Supprimer', array(
                                                        ...
                                                        'title' => 'Delete User',
                                                        'onclick'=>'return confirm("Etes-vous sur de vouloir supprimer l\'utilisateur?")'
                                                )) !!}
                                            {!! Form::close() !!}
                                        </td>
                                    </tr>
